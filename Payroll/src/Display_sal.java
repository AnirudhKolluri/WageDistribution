...
import java.io.*;
import javax.swing.*;
public class Display_sal extends javax.swing.JFrame {

    /**
     * Creates new form Display_sal
     */
    public Display_sal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Distribute", jPanel4);
            ...
            for (int i = 0; itemline[i] != null; i++) {
                if (idx == i) {
                    ...
                    if ((qty > qty_prv) && (qty_prv != 0)) {
                        JOptionPane.showMessageDialog(null, "Wrong W.H!", "Oops!", JOptionPane.WARNING_MESSAGE);
                    }
                    if (qty_prv == 0) {
                        JOptionPane.showMessageDialog(null, "Error!", "Oops!", JOptionPane.WARNING_MESSAGE);
                    }
                    if ((qty <= qty_prv) && (qty_prv != 0)) {
                        qty_new = qty_prv - qty;
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            if (jTextField14.getText().equals(""))
                ...
                if (!found) 
                    JOptionPane.showMessageDialog(null, "emp is already not in the list!", "Ooops!", JOptionPane.ERROR_MESSAGE);
                 else 
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            if (jTextField3.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Enter emp!", "Oops Wait...!", JOptionPane.ERROR_MESSAGE);
            } else {
                BufferedReader rdfile = new BufferedReader(new FileReader("items.txt"));
                ...
                if (!(x >= 100)) {
                    ...
                    if (found) {
                        JOptionPane.showMessageDialog(null, "Emp already exist!\nSuggestion: Update Item", "", JOptionPane.WARNING_MESSAGE);
                    } else {
                        qty = Integer.parseInt(jTextField4.getText());
                        sal = Double.parseDouble(jTextField5.getText());

                        itemline[x] = name + "\t" + qty + "\t" + sal;
        ...
        // Save Changes(Update)
         ...
         try{
            if( jTextField6.getText().equals(""))
                ...
                String[] itemline= new String[100];
                String temp[];
                String search= "", name="", Qty="", Sal="";
                search= jTextField6.getText();
                int qty=0, x=0; double sal=0.0;
                boolean found= false;

                name= jTextField7.getText();
                Qty= jTextField8.getText();
                Sal= jTextField9.getText();
                if( (!(name.equals(""))) || (!(Qty.equals(""))) || (!(Sal.equals(""))) ){
                    while(( itemline[x]= rdfile.readLine()) != null){
                        temp= itemline[x].split("\t");
    ...
    public static void main(String args[]) {  
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Display_sal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Display_sal().setVisible(true);
            }
        });
    }
